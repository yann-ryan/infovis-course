...
![](images/Screenshot 2023-08-31 at 12.15.19.png){width="600"}
...
![](images/Screenshot 2023-08-31 at 12.18.31.png)
...
The next group of functions group things together and count them.
...
For example, we can use `mutate()` to create a new column, adding the results of `amount` and `amount_last_week`. Here, we are telling mutate to create a new column called `total_amount`, and for each row, that column should be the result of adding together the other two columns:
